%Find critical invariant J (J1 or J2)WITH 3ALPHADELTAT calculation
...
for x=Theta_min:Theta_step:Theta_max %fibre angle
    for y=deltaT_min:deltaT_step:deltaT_max %temp
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %Find expstrain that produces J1 crticial invariant INCL.
        %J1crit=3*alpha*deltaT
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        while J1crit_invariant==0
           ...
           % [strain_vector] = ansys_strains(Theta,theta_strain);
            ...
            %determine strain ct
            %b=expstrain;
            %[strain_ct] = coordinate_transformation_test(Theta,nu23,a,b,d,e,f);
